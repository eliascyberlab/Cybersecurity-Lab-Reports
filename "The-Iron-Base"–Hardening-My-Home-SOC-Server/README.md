...
I configured the Uncomplicated Firewall (UFW) to a "Default Deny" posture. I explicitly opened only the ports required for SSH (22), SIEM dashboards (443), and security agents (1514/1515). A server should only "speak" when necessary. By blocking all incoming traffic by default, I significantly reduced the attack surface of my home lab.
